...
const mainLinks = [
  ...
  { title: `Friday Reviews`, path: `/review`, icon: <ReviewsIcon color="primary" /> },
  { title: `Games`, path: `/games`, icon: <VideogameAssetIcon color="primary" /> },
...
const socials = [
  ...
  { path: `https://youtube.com/nymnion`, icon: <YouTubeIcon color="primary" /> },
  {
    path: `https://discord.gg/nymn`,
    icon: (
  ...
  {
    path: `https://twitter.com/nymnion`,
    icon: <TwitterIcon color="primary" />,
  },
  {
    path: `https://twitch.tv/nymn`,
    icon: (
