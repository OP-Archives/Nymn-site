              ...
              <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", width: "100%", height: "100%" }}>
                ...
                {TEAM_A.submission && (
                  <>
                    ...
                    {contest.type === "alert" && (TEAM_A.submission.video?.source === "twitch" || !TEAM_A.submission.video.source) && (
                      <Box sx={{ m: 1, height: "100%", width: isMobile ? "100%" : "60%" }}>
                        <iframe
                    ...
                    {contest.type === "alert" && (TEAM_A.submission.video?.source === "streamable" || !TEAM_A.submission.video.source) && (
                      <Box sx={{ m: 1, height: "100%", width: isMobile ? "100%" : "60%" }}>
                        <iframe
                          title={TEAM_A.submission.video.id}
                          src={`https://streamable.com/e/${TEAM_A.submission.video.id}`}
                          height="500px"
                          width="100%"
                          allowFullScreen={true}
                          preload="auto"
              ...
              <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", width: "100%" }}>
                ...
                {TEAM_B.submission && (
                  <>
                    ...
                    {contest.type === "alert" && (TEAM_B.submission.video?.source === "twitch" || !TEAM_B.submission.video.source) && (
                      <Box sx={{ m: 1, height: "100%", width: isMobile ? "100%" : "60%" }}>
                        <iframe
                    ...
                    {contest.type === "alert" && (TEAM_B.submission.video?.source === "streamable" || !TEAM_B.submission.video.source) && (
                      <Box sx={{ m: 1, height: "100%", width: isMobile ? "100%" : "60%" }}>
                        <iframe
                          title={TEAM_B.submission.video.id}
                          src={`https://streamable.com/e/${TEAM_B.submission.video.id}`}
                          height="500px"
                          width="100%"
                          allowFullScreen={true}
                          preload="auto"
